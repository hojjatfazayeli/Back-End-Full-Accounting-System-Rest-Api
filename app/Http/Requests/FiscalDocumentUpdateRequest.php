...
class FiscalDocumentUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
          ...
          //  'fiscal_document.cheque_id' => ['required' , 'exists:cheques,id'],
           // 'fiscal_document.cheque_sheet_id' => ['required' , 'exists:cheque_sheets,id'],

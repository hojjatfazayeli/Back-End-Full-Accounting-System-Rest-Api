...
return [
    ...
    */
    'attributes' => [
		...
		"fullname" => "نام کامل",
        "media"=>"مدیا",
        "category_id"=>"شناسه دسته-زیردسته",
        "parent"=>"والد",
        "picture"=>"تصویر بلاگ",
        "blog_id"=>"شناسه بلاگ",
        "sort"=>"روش مرتب سازی",
        ...
        "settlement"=>"روش تسویه حساب",
        "shipping"=>"روش ارسال محصول",
        "origin"=>"نوع فاکتور",
        "cargo"=>"روش حمل محصول",
        "total_tonnage"=>"مجموع توناژ فاکتور",
        "totalprice"=>"مجموع هزینه فاکتور محصول",
        "user_id"=>"شناسه کاربر",
        "property_id"=>"شناسه مشخصه محصول",
        "status"=>"وضعیت",
        "blog_id"=>"شناسه مقاله",
        "product_id"=>"شناسه محصول",
        "pricefile"=>"فایل اعلامیه قیمت",
        'trackingcode'=>"کد رهگیری فایل",
        'code'=>'کد شخص',
        'nationalid'=>'کدملی / شناسه ملی',
        'economiccode'=>'کد اقتصادی',
        'postalcode'=>'کد پستی',
        'account_number'=>'شماره حساب',
        'cart_number'=>'شماره کارت',
        'sheba_number'=>'شماره شبا',
        'items'=>'شناسه های مورد نظر',
        'nationalcode'=>'کد ملی',
        'marketer_id'=>'شناسه بازاریاب',
        'reason'=>'علت تاخیر',
        'store_id'=>'شناسه انبار',
        'groupe_product_id'=>'شناسه گروه کالا',
        'barcode'=>'بارکد یا سریال محصول',
        'last_purchase_price'=>'آخرین قیمت خرید',
        'basic_selling_price'=>'قیمت فروش پایه',
        'weight_number'=>'وزن یک قلم',
        'single_number'=>'تعداد جزء',
        'average_purchase_price'=>'میانگین قیمت خرید',
        'unit_id'=>'شناسه واحد',
        'number_in_box'=>'تعداد در کارتن',
        'offer'=>'آفر',
        'serial'=>'سریال چک',
        'avatar'=>'تصویر پروفایل',
        'role'=>'نقش',
        'balance_status'=>'وضعیت موجودی محصول',
        'total_code'=>'کد کل',
        'totalcode'=>'کد کل',
        'account_groupe_id'=>'شناسه گروه حساب',
        'bank_id'=>'شناسه بانک',
        'birth_certificate_id'=>'شماره شناسنامه',
        'personal_id'=>'کدپرسنلی',
        'relation'=>'ارتباط فرد با مشترک',
        'life_situation'=>'وضعیت حیات',
        'firstname'=>'نام',
        'lastname'=>'نام خانوادگی',
        'start_date' => 'تاریخ شروع سال مالی',
        'end_date' => 'تاریخ پایان سال مالی',
        'amount_membershipـright_month' => 'حق اشتراک ماهانه',
        'amount_participate_right' => 'حق مشارکت',
        'amount_membership_fee' => 'حق عضویت صندوق',
        'amount_motivational' => 'کسرانگیزشی',
        'payment_tracking_code' => 'کدرهگیری تراکنش',
        'items.*.account_id' => 'شناسه حساب',
        'fiscal_document.nature_document' => 'ماهیت سند',
        'fiscal_document.type_document' => 'نوع سند',
        'fiscal_document.title' => 'عنوان سند',
        'fiscal_document.status' => 'وضعیت سند',
        'fiscal_document.description' => 'توضیحات سند',
        'fiscal_document.document_date' => 'تاریخ سند',
        'fiscal_document.payment_date' => 'تاریخ پرداخت سند',
        'payment_date' => 'تاریخ پرداخت',
        'fiscal_document.fiscal_year' => 'سال مالی سند',
        'fiscal_document.fiscal_month' => 'ماه مالی سند',
        'fiscal_document.cheque_id' => 'شناسه چک سند',
        'fiscal_document.cheque_sheet_id' => 'شناسه برگ چک سند',
        'items.*.deptor' => 'مبلغ بدهکار',
        'items.*.creditor' => 'مبلغ بستانکار',
        'receipt_number' => 'شماره فیش',
        'deposit_date' => 'تاریخ واریز',
        'fiscal_year' => 'سال مالی',
        'fiscal_month' => 'ماه مالی',
        'bank_list_id' => 'بانک موردنظر',
        'fiscal_document_id' => 'شناسه سند'
    ],
];
